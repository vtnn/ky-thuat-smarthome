...
#### 1. Lưu ý chung trước khi thi công

Màn hình Nature (Mini, Mini Pro) chạy nền tảng hệ điều hành phức tạp và đấu điện lưới 220V trực tiếp. Phần vỏ chia làm 2 cụm rất dễ ngàm: Cụm nguồn nằm trong đế âm và Cụm vi mạch màn hình nằm ngoài. 

Để đảm bảo thiết bị chạy không bị cháy nổ ngắn mạch do hồ quang, anh em kỹ thuật phải thực hiện trình tự bóc tách và siết ốc cực kỳ chuẩn xác.

#### 2. Quy trình lắp ráp cơ khí và đấu điện

**Bước 1: Cắt điện và kiểm tra an toàn**
- Trước lúc can thiệp kéo dây vào màn hình, hãy dập hẳn CB (Aptomat) cấp nguồn cục bộ nhánh đó. 
...
- Đưa lõi đồng cáp từ tường ra cắm ngập vào terminal. Lõi đồng tuốt vỏ chỉ lộ tầm 6mm tới mức chạm ngập.
- Bắt buộc phải siết nén chặt ốc cáp N (nguội) và L (lửa) nuôi bo. 
- Nếu ngõ L1, L2 lộ ra mà không sử dụng thì để trống, tuyệt đối không đấu chập các nhánh này lại với nhau. Đây là điểm mấu chốt quyết định nguồn điện nuôi vi xử lý bên trong màn hình bật có ổn định qua năm tháng hay không. Nếu lỏng vòng ốc, nhiệt lượng tỏa ra khi nháy bóng đèn lớn sẽ làm cháy đen chân nhựa bên cạnh.
...
- Lùa các đoạn dây cáp dài xếp nếp gọn gàng ôm vào thành đế âm. Không để cáp đè nghẽn giữa.
- Ấn đế cấp điện vào trong lỗ khoét hộp và dùng ốc hai bên hông vặn siết chặt vừa tay để mặt ngàm bám sát vách tường.

**Bước 5: Lên nguồn cấp điện rà soát**
- Ráp khít mặt màn hình khớp trở lại đế công tắc âm tường vừa gắn. 
- Bật CB cấp điện trở lại. 
- Màn hình sẽ chớp nháy đen hoặc logo hãng mất vài chục giây khởi động hệ điều hành cho đến khi sáng lên giao diện chọn ngôn ngữ hay trang dashboard hiện tại.
...
- Chân K1 / K2: đấu vào cực lộ L1 hoặc L2 trên công tắc cơ.
...
Cách thi công: nhồi 1 Module duy nhất vào hộp đế có đủ cáp. Chân G và K1 nối vào cổng L và L1/L2 của hệ lẩy đấu 3 cực đảo chéo truyền thống. Bấm phím ở đầu nào, tín hiệu cũng chạy qua dây liên lạc chung về cổng G-K1, CUBE đọc được và đảo trạng thái đèn.

![Sơ đồ đảo chiều bằng cáp chéo K1](../../../../../assets/images/wiki/module-b/b1-lifesmart/cube_double_1.png)
<p class="hero-image-caption">Cách đi chéo truyền thống: mượn 3 lõi cáp liên lạc báo gộp vào K1, chỉ cần 1 Module duy nhất.</p>

#### Cách 2: Dùng 2 Module kết nối không dây (nhà không có cáp liên lạc nối thông)
...
- Hộp đế phía trên (nơi nắm cáp kéo đèn): gắn Module số 2 vào. Đấu G / K1 cho lẩy công tắc cơ, mắc N / L nuôi sống board, và đấu L1 lên bóng đèn.
- Hộp đế phía dưới (không có cáp đèn): gán Module số 1 vào. Đấu G / K1 cho lẩy công tắc cơ, mắc N / L cấp điện nuôi board. Chân L1 bỏ trống vì hộp này không nối bóng đèn.
...
### Cổng ra tín hiệu (AIR CON Terminals) và cáp

- Cổng dữ liệu điều hoà (AIR CON Terminals) dùng để kết nối với cục nóng hoặc cục lạnh.
...
LS212 kết nối trực tiếp vào dàn lạnh bằng cáp tín hiệu có dây. Thiết bị này nhạy cảm với lỗi đấu nối hơn HVAC Gateway thông thường vì nó giao tiếp 1-1 với từng dàn lạnh riêng biệt.

### 1. Cắt điện hoàn toàn trước khi đấu nối
...
Dùng nguồn DC 12V đi kèm thiết bị hoặc nguồn chuẩn quy cách từ nhà sản xuất uy tín. Không dùng nguồn tạp, nguồn không ổn áp.

### 3. Đấu cáp tín hiệu vào dàn lạnh

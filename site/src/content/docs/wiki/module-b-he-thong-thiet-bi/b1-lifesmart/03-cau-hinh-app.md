...
4. **Cập nhật Firmware (Bắt buộc)**: Ngay sau khi thêm thành công, anh em phải vào **Engineering Settings → Update Smart Device** để cập nhật Smart Station lên bản Firmware mới nhất. Bước này rất quan trọng để Hub nhận diện được các thiết bị con đời mới và chạy kịch bản ổn định.

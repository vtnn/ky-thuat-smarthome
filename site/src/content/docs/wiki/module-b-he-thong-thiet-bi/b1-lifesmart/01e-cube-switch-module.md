...
![Hình dáng thiết bị CUBE Switch Module](../../../../../assets/images/cube_1.png)
...
- **Bắt buộc kéo dây Nguội (N):** CUBE yêu cầu nuôi điện màn liên tục. Trong hộp công tắc phải có luồng hạ đủ tiết diện cả dây N (Nguội) và dây L (Lửa). Dây nguồn không xuống đủ, hệ thống không chạy.
...
![Sơ đồ CUBE 2 lộ điều khiển sáng đèn](../../../../../assets/images/cube_6.png)
...
![Sơ đồ đảo chiều bằng liên kết dòng cáp lẫy mạch chéo K1](../../../../../assets/images/cube_double_1.png)
...
![Sơ đồ thả nổi tự lập Triggers bằng hai bo CUBE riêng](../../../../../assets/images/cube_double_2.png)
